...
public class MenuDto {
	...
	public String toString() {
		return "MenuDto [menu_no=" + menu_no + ", id=" + id + ", title=" + title + ", descript=" + descript + ", depth="
				+ depth + ", parent_no=" + parent_no + ", lvl=" + lvl + ", use_yn=" + use_yn + ", forder_yn="
				+ forder_yn + ", ins_date=" + ins_date + ", upt_date=" + upt_date + "]";
	}
